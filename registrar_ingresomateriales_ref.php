...
<th colspan='1'>Fecha Documento Proveedor: <input type='date' class='texto' name='fecha_factura_proveedor' id='fecha_factura_proveedor' value='$cab_fecha_factura_proveedor' ".(($banderaCamposEscondidos == 1 || $cab_cod_tipopago != 4) ? 'readonly' : '')."></th>";
...
<input type='hidden' name='materialActivo' value="<?=$index_detalle?>">

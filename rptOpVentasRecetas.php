...
{	var fecha_ini, fecha_fin;
	...
	window.open('rptVentasRecetaRepo.php?&fecha_ini='+fecha_ini+'&fecha_fin='+fecha_fin+''+'&codSubGrupo=0'+'&rpt_formato='+formato,'','scrollbars=yes,status=no,toolbar=no,directories=no,menubar=no,resizable=yes,height=800');			
	return(true);
}

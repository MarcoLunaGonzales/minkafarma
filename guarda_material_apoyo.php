...
cantidad_presentacion, principio_activo, cod_tipoventa, producto_controlado, accion_terapeutica, codigo_barras, bandera_venta_unidades, cod_tipo_material) values ($codigo,'$nombreProducto','1','$codLinea','$codForma','$codEmpaque',
'$cantidadPresentacion','$principioActivo','$codTipoVenta','$productoControlado','$accionTerapeutica','$codigoBarras','$ventaSoloCajas','$codTipoMaterial')";
//echo $sql_inserta;
